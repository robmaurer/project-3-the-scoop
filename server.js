...
const persistedDatabasePath = './database.yml';
...
function loadDatabase() {
    return YAML.load(persistedDatabasePath);
}

function saveDatabase() {
    yamlString = YAML.stringify(database);

    fs.truncate(persistedDatabasePath, 0, () => {
        fs.writeFile(persistedDatabasePath, yamlString, () => console.log('error persisting database'));
    });
}
